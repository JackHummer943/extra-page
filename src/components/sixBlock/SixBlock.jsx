        ...
        <div className="six_row">
          ...
          <div className="six_description">
            <p className="six_description_text">
              ...
              individual artwork, as well as the best way to create "the show," with the Vernissage
              team. Intense back-and-forth and many rounds of reviewing each application were part
            ...
            <p className="six_description_text">
              ...
              actually installing all of the artworks. On the other hand, the curation of a digital
              exhibition takes place on the screen of the computer. As a consequence of this, the
              final result can only be appreciated on the opening night of the exhibition; you can
              only see the "preview" and, if absolutely necessary, discuss the specifics with the
